...
class DatasetFactory():
    @staticmethod
    def get_dataset(dataset_name, max_sample, root, coco_json_path=None, force_recompute=False):
        ...
        if dataset_name == "twincity":
            ...
            twincity_processor = TwincityProcessing(root, max_samples=max_sample)
