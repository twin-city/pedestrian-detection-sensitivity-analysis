...
class DatasetFactory():
    @staticmethod
    def get_dataset(dataset_name, max_samples_per_sequence, root, force_recompute=False):
        ...
        # Handle case for coco datasets which have a coco.json file at the root
            ...
            coco_dataset = COCOProcessing(root, dataset_name, max_samples_per_sequence=max_samples_per_sequence)
